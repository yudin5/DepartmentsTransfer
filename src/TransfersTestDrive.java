...
public class TransfersTestDrive {
     ...
     */
    private static void writeResultToFile(ArrayList<Department> departments, ArrayList<String> dispositions, String outputFileName) throws IOException {
        ...
        fileWriter.close();
        System.out.println("Готово. Проверьте файл с результатом " + outputFileName);
    }
     ...
     */
    private static ArrayList<String> makeDispositions(ArrayList<Department> departments) {
